...
const tr: Dict = {
  ...
  "diet.tips": "İpuçları",
  "diet.pace": "Tempo",
  "diet.pace.slow": "Yavaş",
  "diet.pace.normal": "Normal",
  "diet.pace.fast": "Hızlı",
  "diet.meals": "Öğün sayısı",
  "diet.cuisine": "Mutfak tercihi",
  "diet.cuisine.ph": "Örn. Türk, Akdeniz, Asya",
  "diet.avoid": "Kaçındığınız besinler",
  "diet.avoid.ph": "Örn. laktoz, kırmızı et, acı",
  "diet.water": "Su hedefi",
  "diet.shopping": "Alışveriş Listesi",
  "diet.copy": "Planı kopyala",
  "diet.copied": "Plan kopyalandı.",
  "diet.regenerate": "Yeniden oluştur",
  "diet.note": "Planlar tahminî hesaplamalara dayanır ve tıbbi tavsiye değildir.",

  "analyze.type.barcode": "Barkod",
  "analyze.barcode.status": "Ürün veritabanından getiriliyor...",
  "analyze.barcode.manual": "Barkodu elle girin",
  "analyze.barcode.manual.ph": "Örn. 8690504000000",
  "analyze.barcode.submit": "Sorgula",
  "analyze.barcode.hint": "Barkodu çerçevenin içine hizalayın — otomatik okunur.",
  "analyze.barcode.title": "Barkod & QR Tarayıcı",
  "analyze.barcode.torch": "Işığı aç/kapat",
  "analyze.barcode.flip": "Kamerayı değiştir",
  "analyze.barcode.denied": "Kamera izni verilmedi. Tarayıcı ayarlarından izin verin veya barkodu elle girin.",
  "analyze.barcode.nocam": "Kamera bulunamadı. Barkodu elle girebilirsiniz.",
  "analyze.barcode.insecure": "Kamera yalnızca güvenli (HTTPS) bağlantıda çalışır.",
  "analyze.barcode.failed": "Kamera başlatılamadı. Barkodu elle girebilirsiniz.",
  "analyze.barcode.notfound": "Ürün veritabanında bulunamadı. Etiket fotoğrafıyla analiz edebilirsiniz.",
  "analyze.barcode.usePhoto": "Fotoğrafla analiz et",
  "analyze.camera": "Kamera",
...
const en: Dict = {
  ...
  "diet.pace.normal": "Normal",
  "diet.pace.fast": "Fast",
  "diet.meals": "Meals per day",
  "diet.cuisine": "Cuisine preference",
  "diet.cuisine.ph": "e.g. Turkish, Mediterranean, Asian",
  "diet.avoid": "Foods you avoid",
  "diet.avoid.ph": "e.g. lactose, red meat, spicy",
  "diet.water": "Water target",
  "diet.shopping": "Shopping list",
  "diet.copy": "Copy plan",
  "diet.copied": "Plan copied.",
  "diet.regenerate": "Regenerate",
  "diet.note": "Plans are based on estimates and are not medical advice.",

  "analyze.type.barcode": "Barcode",
  "analyze.barcode.status": "Fetching product from the database...",
  "analyze.barcode.manual": "Enter barcode manually",
  "analyze.barcode.manual.ph": "e.g. 8690504000000",
  "analyze.barcode.submit": "Look up",
  "analyze.barcode.hint": "Align the barcode inside the frame — it scans automatically.",
  "analyze.barcode.title": "Barcode & QR scanner",
  "analyze.barcode.torch": "Toggle light",
  "analyze.barcode.flip": "Switch camera",
  "analyze.barcode.denied": "Camera permission denied. Allow it in your browser settings or type the barcode.",
  "analyze.barcode.nocam": "No camera found. You can type the barcode instead.",
  "analyze.barcode.insecure": "The camera only works over a secure (HTTPS) connection.",
  "analyze.barcode.failed": "Camera could not start. You can type the barcode instead.",
  "analyze.barcode.notfound": "Product not found in the database. Try analyzing the label photo instead.",
  "analyze.barcode.usePhoto": "Analyze with photo",
